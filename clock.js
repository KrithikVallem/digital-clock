function getNewTime() {
    const d = new Date();
    const h24 = d.getHours().kv_addPaddingZero();
    const h12 = d.getHours().kv_convertHoursTo12();
    const m = d.getMinutes().kv_addPaddingZero();
    const s = d.getSeconds().kv_addPaddingZero();
...
Number.prototype.kv_addPaddingZero = function() {
    if (this.valueOf() < 10) {
...
Number.prototype.kv_convertHoursTo12 = function() {
    // hour 0 is 12:00 AM
    if (this.valueOf() === 0) {
        return 12;
    }
